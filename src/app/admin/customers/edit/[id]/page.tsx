...
export default async function EditCustomerPage(props: PromisedParams) {
  ...
  return (
    <>
      <div className="container flex flex-col space-y-4 p-6 text-muted">
        ...
        <Card className="border-gray-700 bg-gray-800">
          ...
          <CardContent className="grid gap-2 text-muted">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="font-semibold text-base text-muted">
                    Date
                  </TableHead>
                  <TableHead className="font-semibold text-base text-muted">
                    Old Status
