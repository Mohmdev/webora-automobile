...
import { Modal, ModalBody, ModalContent, ModalFooter, ModalTrigger } from '.'
      ...
      <Modal>
        <ModalTrigger>
          ...
          >
            ...
            <div className="-translate-x-40 absolute inset-0 z-20 flex items-center justify-center text-white transition duration-500 group-hover/modal-btn:translate-x-0 dark:text-black">
              ✈️
            </div>
          </Button>
        </ModalTrigger>
...
const PlaneIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Plane</title>
...
const VacationIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Vacation</title>
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const ElevatorIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Elevator</title>
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const FoodIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Food</title>
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const MicIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Mic</title>
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
const ParachuteIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <title className="sr-only">Parachute</title>
      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
