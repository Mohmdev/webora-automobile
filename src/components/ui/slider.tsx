  ...
  const renderThumb = (value: number) => {
    const thumb = (
      <SliderPrimitive.Thumb
        ...
        className="block size-3 rounded-full border-2 border-primary bg-background transition-colors focus-visible:outline focus-visible:outline-ring/40 data-[disabled]:cursor-not-allowed"
    ...
    return (
      <TooltipProvider>
        <Tooltip data-slot="slider-tooltip" open={showTooltipState}>
  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="relative grow overflow-hidden rounded-full bg-secondary data-[orientation=horizontal]:h-1 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-1"
      >
